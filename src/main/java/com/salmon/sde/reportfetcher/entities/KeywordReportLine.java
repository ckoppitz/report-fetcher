...
@Entity
public class KeywordReportLine extends AbstractReportLine
{
	public static final String METRICS = "campaignName,campaignId,keywordId,keywordText,matchType,impressions,clicks,cost," +
